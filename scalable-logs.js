...
function amount(x){return x.totalAmount!==undefined&&x.totalAmount!==null&&x.totalAmount!==''?`${x.currency||'MYR'} ${Number(x.totalAmount||0).toFixed(2)}`:'';}

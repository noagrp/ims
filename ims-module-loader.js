import { can, currentRole } from './ims-permissions.js?v=20260910-19';

const IMS_BUILD='20260910-19';
...
function refreshImportExport(){if(!window.IMSRegistrationCSV?.install)return;queueMicrotask(()=>window.IMSRegistrationCSV?.install?.());setTimeout(()=>window.IMSRegistrationCSV?.install?.(),100);setTimeout(()=>window.IMSRegistrationCSV?.install?.(),400);}
